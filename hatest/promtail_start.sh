...
# Start it
$HATEST_PROMTAIL_HOME/promtail-linux-amd64 -log.level=debug -config.expand-env=true -config.file=$HATEST_CODE/promtail.yaml >$HATEST_LOG_DIR/promtail.log 2>&1 &
